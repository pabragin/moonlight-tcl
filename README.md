...
15. **What the MediaTek decoder costs per codec and resolution (measured on the C8K, 60 FPS, 100 Mbps, HDR, post-stream
   ...
   | HEVC 3840×2160, HDR, 60 Mbps | 12 ms | 12 ms | |
...
декодера MediaTek при 60 к/с и 100 Мбит/с: HEVC 4K с HDR 15–16 мс, без HDR 14 мс, при 60 Мбит/с 11 мс, с HDR при 60 Мбит/с 12 мс и при 40 Мбит/с 11 мс, H.264 4K 14–15 мс (один прогон из трёх дал 58 мс и 23 к/с, не повторился), HEVC 1440p 7 мс,
