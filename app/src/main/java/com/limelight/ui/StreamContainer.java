...
/**
 * Hosts the stream SurfaceView, forwards input callbacks and applies aspect ratio scaling.
 * The Artemis 3D (GLSurfaceView + depth estimation) render modes were removed from this build:
 * a TV stream only ever needs the plain SurfaceView path.
 */
public class StreamContainer extends FrameLayout implements SurfaceHolder.Callback {
    ...
    public void onDestroy() {
        // Nothing to release: the SurfaceView is torn down with the view hierarchy
    }
}
